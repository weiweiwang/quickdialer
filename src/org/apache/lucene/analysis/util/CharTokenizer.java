 ...
 * {@link org.apache.lucene.util.Version} argument. Based on the given {@link org.apache.lucene.util.Version} either the new
 * API or a backwards compatibility layer is used at runtime. For
 * {@link org.apache.lucene.util.Version} < 3.1 the backwards compatibility layer ensures correct
 * behavior even for indexes build with previous versions of Lucene. If a
 * {@link org.apache.lucene.util.Version} >= 3.1 is used {@link CharTokenizer} requires the new API to
 ...
 * compatible if instantiated with {@link org.apache.lucene.util.Version} < 3.1.
 * </p>
 * <p>
 * <strong>Note:</strong> If you use a subclass of {@link CharTokenizer} with {@link org.apache.lucene.util.Version} >=
